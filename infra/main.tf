...
# NAT Instance (Cost Saving replacing NAT Gateway)
# Using generic Amazon Linux 2 AMI
...
resource "aws_instance" "nat" {
  ...
  instance_type               = "t3.nano" # Cost effective
  subnet_id                   = aws_subnet.public_1.id
...
data "archive_file" "lambda_zip" {
  type        = "zip"
  source_dir  = "${path.module}/lambda/logs_to_elk"
  output_path = "${path.module}/lambda/logs_to_elk.zip"
}
...
variable "elasticsearch_endpoint" {
  description = "Elasticsearch Endpoint (Self-hosted or OpenSearch)"
...
resource "aws_codebuild_project" "build" {
  ...
  description   = "Builds the Docker image and updates ECS"
  build_timeout = "60"
